...
import { CalendarPlus, Car, CheckCircle2, Clock, MessageSquarePlus, MessagesSquare, PlusCircle } from 'lucide-react';
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4 text-center">
                            <div className="rounded-lg border p-3">
                                <p className="text-2xl font-bold text-foreground">{myComplaints.counts.open}</p>
                                <p className="text-xs text-muted-foreground">Open</p>
                            </div>
                            <div className="rounded-lg border p-3">
                                <p className="text-2xl font-bold text-foreground">{myComplaints.counts.total}</p>
                                <p className="text-xs text-muted-foreground">Total</p>
                            </div>
                        </div>

                        {myComplaints.recent.length > 0 ? (
                            <div className="space-y-2">
                                {myComplaints.recent.map((complaint) => (
                                    <Link
                                        key={complaint.id}
